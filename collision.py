...
def collision_constraint(particle1,
	...
	correction_x2 = 0.0
	correction_y2 = 0.0
	curr_distance = distance(particle1.px, particle1.py, particle2.px, particle2.py)
	constraint_distance = particle1.r + particle2.r
	if curr_distance < constraint_distance:
		#Normalize
		dir_ix = (particle2.px - particle1.px)/curr_distance
		dir_iy = (particle2.py - particle1.py)/curr_distance
		dir_jx = (particle1.px - particle2.px)/curr_distance
		dir_jy = (particle1.py - particle2.py)/curr_distance

		diff_distance = curr_distance - constraint_distance

		propi = (particle1.inv_mass/(particle1.inv_mass + particle2.inv_mass))
		propj = (particle2.inv_mass/(particle1.inv_mass + particle2.inv_mass))

		correction_x1 = propi * diff_distance * dir_ix
		correction_y1 = propi * diff_distance * dir_iy
		
		correction_x2 = propj * diff_distance * dir_jx
		correction_y2 = propj * diff_distance * dir_jy
