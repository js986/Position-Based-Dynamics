...
def distance_constraint(particle1,
    ...
    correction_x1 = propi * (curr_distance-constraint_distance) * ((particle1.px - particle2.px)/curr_distance)
    correction_y1 = propi * (curr_distance-constraint_distance) * ((particle1.py - particle2.py)/curr_distance)
    
    correction_x2 = propj * (curr_distance-constraint_distance) * ((particle1.px - particle2.px)/curr_distance)
    correction_y2 = propj * (curr_distance-constraint_distance) * ((particle1.py - particle2.py)/curr_distance)
